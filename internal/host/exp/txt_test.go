...
func TestStripChapterTitleHeader(t *testing.T) {
	cases := []struct {
		...
		{"strip h1 vietnamese title", "# Chương 1  Mưa đêm người về\n\nAnh nhìn ra cửa sổ.", "Mưa đêm người về", "Anh nhìn ra cửa sổ."},
		{"strip h2 with chapter token", "## 第二章\n\n他望着窗外。", "", "他望着窗外。"},
		{"strip h2 with vietnamese chapter token", "## Chương 2\n\nAnh nhìn ra cửa sổ.", "", "Anh nhìn ra cửa sổ."},
		{"keep body even if no header", "正文第一句。\n第二句。", "", "正文第一句。\n第二句。"},
		{"do not strip non-chapter heading", "# 序章\n他望着窗外。", "边村浮生", "# 序章\n他望着窗外。"},
		{"single line header only", "# 第 1 章", "", ""},
		{"single line header vietnamese only", "# Chương 1", "", ""},
